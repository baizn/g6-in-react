...
export default function() {
  ...
  const [edgeTooltipY, setEdgeTooltipY] = useState(-300)

  // 节点tooltip坐标
  const [nodeTooltipX, setNodeToolTipX] = useState(0)
  const [nodeTooltipY, setNodeToolTipY] = useState(-350)

  // 节点ContextMenu坐标
  const [nodeContextMenuX, setNodeContextMenuX] = useState(-300)
  ...
  return (
    <div ref={ref}>
      ...
      <NodeTooltips x={nodeTooltipX} y={nodeTooltipY} />
